...
#municipio structure data = (`id_municipio`, `municipio`, `estado`, `departamento_id`)
municipios_list =[
    (1,'Abriaquí',1,5),
	(2,'Acacías',1,50),
	(3,'Acandí',1,27),
...
for departamento in departamentos_list:
    ...
    departamento_instance=Departamentos( 
...
for municipio in municipios_list:
    ...
    departamento_instance=Departamentos.objects.get(id_departamento=municipio[3])
    
    municipio_instance=Municipios( 
               id_municipio = municipio[0],
               municipio = municipio[1],
               estado = municipio[2],
               departamento_id = departamento_instance
               )
